...
INFER_SCRIPT = INFERENCE_DIR / "infer.py"
...
def system_check() -> dict[str, Any]:
    ...
    add("Inference script", INFER_SCRIPT.exists(), str(INFER_SCRIPT))
...
def system_check_markdown() -> str:
    ...
    if report["ready"]:
        ...
        lines.append(
            ...
            "The UI will not launch a generation job until these are fixed."
        )
    return "\n".join(lines)
